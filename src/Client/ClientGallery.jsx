...
function ClientGallery() {
  const [gallerModal, setGalleryModal] = useState(false);
  const openModal =()=> setGalleryModal(true)
        ...
        <section className=' justify-center h-sm md:h-md lg:h-96  overflow-auto' >
          <div className='gallery-section '>
              <div className='gallery-container' onClick={openModal}>
                <div className='aspect-3/2 rounded-2xl bg-contain overflow-hidden gallery-content'>
                  <img src={SampleImage} alt=""  />
                </div>
                <label className='text-2xl pt-2 pb-4 px-2'>Sample Location</label>
              </div>
                ...
                >
                  ...
                  <div className='flex my-2 lg:my-5 flex-col justify-start size-full'>
                    <div className='flex flex-row items-center mx-4'>
                      <label className='text-3xl m-3 font-bold uppercase'>Phinma Hall</label>
                    </div>
                    <span className='gal-cont-inf'>
                      <p>Sample tEX: I miss you my baby, I want to hug and kiss you right now</p>
                    </span>
                  </div>
                </motion.div>
              </motion.section>
